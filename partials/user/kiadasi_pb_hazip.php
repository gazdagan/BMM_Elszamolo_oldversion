...
echo $bizonylat -> kiadasi_penztarbizonylat();
echo '</div>';

echo'<div class="container">';
echo '<div id="HiddenIfPrint"><div class="btn-group"><a href="#"onclick="StartPrtintPage('."'kiadas'".')" tpye="button" class="btn btn-info" role="button"><i class="fa fa-print" aria-hidden="true"></i> Nyomtat</a>'
