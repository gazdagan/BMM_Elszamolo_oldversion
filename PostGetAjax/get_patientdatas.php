...
/* 
 páciens adatok kezelése lekérdezése 
 */
...
if (isset($_GET["user_id"]) ){
    ...
    $sql1 = "SELECT * FROM users WHERE  user_id =  '$user_id' AND tipus = 'patient'";
    ...
    if ($result->num_rows > 0) {    
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<form class="form-horizontal" method = "POST" action= "index.php?pid=page10" style ="pagging: 10px;">';
            
            echo '<input type="hidden" value="'.$row["user_id"].'" name="user_id">';
            echo     '<div class="row">
                      <div class ="col-sm-3"><label for="pac">Arteria id:</label></div>
...
//                      <div class ="col-sm-9"><input id="pac" type="password" class="form-control" name="jelszo"  value ="'. $row["jelszo"].'"></div></div>';
            ...
            echo     '<div class="row">
                      ...
                      <div class ="col-sm-9"><input id="pac" type="text" class="form-control" name="tipus"  value ="'. $row["tipus"] .'" readonly></div></div>';
            ...
            echo     '<div class="row">
                      ...
                      <div class ="col-sm-9"><input id="pac" type="text" class="form-control" name="CardSerialNo" placeholder="Olvasd ki a kártyaolvasóval" value =""></div></div>';
